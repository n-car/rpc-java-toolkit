...
- Added `handleRequest(String, Object)` for request-scoped middleware and handler context.

### Fixed

- Aligned the introspection version with the published project version.
