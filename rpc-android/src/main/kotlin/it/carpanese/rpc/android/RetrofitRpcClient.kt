package it.carpanese.rpc.android
...
class RetrofitRpcClient(
    ...
    suspend fun call(method: String, params: JsonElement? = null, id: Any = System.currentTimeMillis()): JsonElement {
        ...
        if (response.isError) {
            throw it.carpanese.rpc.core.RpcException(response.error)
        }

        return response.result ?: throw it.carpanese.rpc.core.RpcException(
            it.carpanese.rpc.core.RpcError.INTERNAL_ERROR,
            "Empty result"
        )
    }
